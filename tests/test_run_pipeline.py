...
import run_pipeline
from pipeline_params import PROFILE_DEFAULT, PROFILE_PREVIEW
...
class RunPipelineTests(unittest.TestCase):
    ...
    def test_uses_full_as_default_profile(self) -> None:
        """Default invocation should run both passes with full profile."""
        with (
    ...
    def test_uses_preview_profile(self) -> None:
        """Preview argument should be passed to both pass scripts."""
        with (
